...
/*   Updated: 2025/02/17 14:37:43 by syl              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_inverting(void)
{
	...
	m_22 = create_matrix(2, 2);
	matrix_fill(m_22, 0, 0, 1);
	matrix_fill(m_22, 0, 1, 5);
	matrix_fill(m_22, 1, 0, -3);
	matrix_fill(m_22, 1, 1, 2);
	print_matrix(m_22);
