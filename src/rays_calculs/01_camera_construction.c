...
/*   Updated: 2025/04/22 09:55:18 by sforster         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	pix[0][0]->cam->m_transf = view_camera(pix[0][0]->cam);
...
void view_camera(t_cam *cam)
{
	...
	// m_view c est 
	cam->m_transf = matrix_multiplication_44(m_orientation, m_translation);
}*/
